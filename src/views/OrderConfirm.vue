<template>
  <div>
    ...
    <nav-bread><span>Order Comfirm</span></nav-bread>
      ...
      <div class="checkout-order">
        ...
        <div class="order-foot-wrap">
          <div class="prev-btn-wrap">
            <router-link class="btn btn--m" to="/address">Back</router-link>
          </div>
          <div class="next-btn-wrap">
            <button class="btn btn--m btn--red" @click="payMent">Comfirm</button>
          </div>
        </div>
      </div>
    </div>
