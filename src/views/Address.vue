<template>
  <div>
        ...
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li
                  v-for="(item, index) in addressListFiltle"
                ...
                >
                  <el-descriptions title="" :column="1" >
                    ...
                    <el-descriptions-item label="居住地"
                      >{{ item.streetName }}</el-descriptions-item
                    >
              ...
              <ul>
                <li class="check">
                  ...
                  <div class="shipping-tips">
                    <p>
                      Once shipped, the order should arrive at the destination
    ...
    <modal :mdShow="mdAddNewAddr" @close="closeModal">
      ...
      <div slot="btnGroup">
        <a href="javascript:;" class="btn btn-m" @click="closeModal">Cancel</a>
        <a href="javascript:;" class="btn btn-m" @click="addAddressConfirm"
          >Save</a
        >
      </div>
    </modal>
