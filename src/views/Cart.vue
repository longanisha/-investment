<template>
  <div>
              ...
              <li v-for="item in cartList">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <span  class="checkbox-btn item-check-btn" :class="{'check':item.checked}" @click="editCart('checked',item)">
                ...
                <el-input-number v-model="item.productNum" @change="handleChange" :min="1" :max="10" label="描述文字"></el-input-number>
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="#" class="item-edit-btn" @click="deleteCart(item)">
          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
                <span href="#" @click="toggleCheckAll">
    ...
    <modal :mdShow="mdShowDelete" @close="closeModal">
      ...
      <div slot="btnGroup">
        <a href="javascript:;" class="btn btn-m" @click="deleteConfirm">Delete</a>
    ...
    methods:{
      ...
      deleteConfirm(){
       ...
       axios.post("/users/cartEdit",{
          ...
          // this.$store.commit("updateCartCount",value)
        })
      },
      editCart(flag,item){
      // if(flag=="checked"){
